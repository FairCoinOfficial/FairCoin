...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/faircoin-project/faircoin/issues>

Compatibility
==============

faircoin Core is extensively tested on multiple operating systems using
...
faircoin Core should also work on most other Unix-like systems but is not
...
[
  {
    ...
    winner: {
        address: addr,    (string) faircoin MN Address,
...
[
  {
    ...
    "addr": addr,      (string) Masternode faircoin address
...
- #195 `aee05fe` [ZMQ] ZMQ integration for faircoin (Mrs-X)
...
### Tests and QA
- #191 `3a778c3` [Tests] Fix the unit test suite for use with faircoin (Fuzzbawls)
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/faircoin-project-translations/).
