...
RESOURCES += src/qt/faircoin.qrc src/qt/faircoin_locale.qrc

TRANSLATIONS += src/qt/locale/faircoin_bg.ts \
                src/qt/locale/faircoin_de.ts \
                src/qt/locale/faircoin_en.ts \
                src/qt/locale/faircoin_es.ts \
                src/qt/locale/faircoin_fi.ts \
                src/qt/locale/faircoin_fr.ts \
                src/qt/locale/faircoin_it.ts \
                src/qt/locale/faircoin_ja.ts \
                src/qt/locale/faircoin_pl.ts \
                src/qt/locale/faircoin_pt.ts \
                src/qt/locale/faircoin_ru.ts \
                src/qt/locale/faircoin_sk.ts \
                src/qt/locale/faircoin_sv.ts \
                src/qt/locale/faircoin_vi.ts \
                src/qt/locale/faircoin_zh_CN.ts \
                src/qt/locale/faircoin_zh_TW.ts
