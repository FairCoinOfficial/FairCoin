...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("faircoin Core"),
     ...
     * override -datadir in the faircoin.conf file in the default data directory
     * (to be consistent with faircoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
