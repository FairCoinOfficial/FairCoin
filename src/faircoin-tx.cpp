...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("faircoin Core faircoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  faircoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded faircoin transaction") + "\n" +
                               "  faircoin-tx [options] -create [commands]   " + _("Create hex-encoded faircoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded faircoin transaction
