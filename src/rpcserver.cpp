...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* faircoin features */
        {"faircoin", "masternode", &masternode, true, true, false},
        {"faircoin", "masternodelist", &masternodelist, true, true, false},
        {"faircoin", "mnbudget", &mnbudget, true, true, false},
        {"faircoin", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"faircoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"faircoin", "mnsync", &mnsync, true, true, false},
        {"faircoin", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"faircoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use faircoind, or the -server option to faircoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:46373/\n";
}
