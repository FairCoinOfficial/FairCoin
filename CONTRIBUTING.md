Contributing to faircoin Core
============================

The faircoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the faircoin Core project, and is not to be
confused with overall faircoin Network Protocol consensus changes.

Whether a pull request is merged into faircoin Core rests with the project merge
...
Patches that change faircoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the faircoin consensus, it must have been
...
The project leader is the release manager for each faircoin Core release.
